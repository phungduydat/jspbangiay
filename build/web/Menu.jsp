        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
            <ul class="navbar-nav m-auto">
                ...
                <c:if test="${sessionScope.acc.isSell == 1}">
                    <li class="nav-item">
                        <a class="nav-link" href="mg">Manager Product</a>
                    </li>
                </c:if>
                ...
                <div class="btn">
                    <c:if test="${sessionScope.acc == null}">
                        <a class="btn btn-success btn-sm ml-3" href="Login.jsp">
                            <i class="fa fa-shopping-cart"></i> GIO HANG
...
<section class="jumbotron text-center">
    <div class="container">
        <h1 class="jumbotron-heading">SHOP GIÀY CỦA ĐẠT</h1>
        <p class="lead text-muted mb-0">TEST THÔI KKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK</p>
    </div>
</section>
<!--end of menu-->
